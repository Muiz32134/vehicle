...
def generate_frames(model_path, rtsp_url):
    ...
    while True:
        ...
        # Assuming 'waiting_times' and 'queue_lengths' are computed elsewhere in the code
...
def video_feed():
    try:
        return Response(generate_frames('best.pt', 'rtsp://admin:Dyna1234@180.74.167.65:551/stream0'),
                        mimetype='multipart/x-mixed-replace; boundary=frame')
    except Exception as e:
        logging.error("Error in video_feed: %s", e)
